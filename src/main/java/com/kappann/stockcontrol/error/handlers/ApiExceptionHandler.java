...
public class ApiExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleUserUnauthorizedError(
      UserUnauthorizedError exception) {
  ...
  public ResponseEntity<ErrorResponse> handleInvalidPayloadError(
      HttpMessageNotReadableException exception) {
    return responseBuilder.badRequest("Invalid value received.");
  }

  @ExceptionHandler(IntegrityViolationError.class)
  public ResponseEntity<ErrorResponse> handleIntegrityViolationError(
      IntegrityViolationError exception) {
